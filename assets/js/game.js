var fightOrSkip = function() {
    ...
    // Conditional Recursive Function Call for "Falsey" values
    if (!promptFight) {
...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0){
        if (isPlayerTurn) {
            ...
            // generate random damage valeu based on player's attack power
...
var startGame = function() {
    ...
    for (var i=0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - i) {
...
var endGame = function() {
    ...
    // if player has more money than high sore, player has new high score.
